...
public record JogoUpdateRequest(
        @Schema(description = "Título do jogo", example = "God Breakers (editado)")
        @NotBlank @Size(max = 200) String titulo,

        @Schema(description = "Descrição do jogo")
        @Size(max = 10_000) String descricao,

        @Schema(description = "Meta financeira da campanha (maior que zero; nula quando não há campanha)", example = "150000.00")
